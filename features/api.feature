...
Feature: DrupalContext
  ...
  Scenario: Create many nodes
    ...
    And I should see "First book"
    And I should see "Second book"
    And I should see "First forum"
    And I should see "Second forum"

  @d8
  Scenario: Create an article with fields
  ...
  @d8
  Scenario: Create a page with fields
    Given "page" content:
    | title                   | promote | body             |
  ...
  @d8
  Scenario: Create and view an article with fields
  ...
  @d8
  Scenario: Create and view a page with fields
    Given I am viewing an "article":
